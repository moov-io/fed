...
// TestACHSearchStateFilter tests string Farmers State Bank and filters by the state of Ohio
...
// TestACHSearchCityFilter tests string Farmers State Bank and filters by the city of ARCHBOLD
